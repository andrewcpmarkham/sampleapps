...
class LocationCollection: Codable{
    ...
    private func loadDefaultLocations() -> [Location] {
        return [
            ...
            Location(id: 2158177, city: "Melbourne", country: "Australia", lat: -37.81, lon: 144.96),
            Location(id: 2174003, city: "Brisbane", country: "Australia", lat: -27.47, lon: 153.03)
        ]
    }
    ...
    func willSetWeatherForLocationAtIndex(at index: Int, with weather: WeatherResponse){
        if let _ = getLocationAtIndex(index: index) {
